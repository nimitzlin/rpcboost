...
class Void : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rpcboost.test.Void)
 private:
...
class InfoMsg : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:rpcboost.test.InfoMsg)
 private:
...
class ServerService_Stub : public ServerService {
 public:
  ...
  void SendServerMsg(::google::protobuf::RpcController* controller,
                       const ::rpcboost::test::InfoMsg* request,
                       ::rpcboost::test::Void* response,
                       ::google::protobuf::Closure* done);
 private:
...
// required bytes msg = 1;
inline bool InfoMsg::has_msg() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void InfoMsg::set_has_msg() {
  _has_bits_[0] |= 0x00000001u;
}
inline void InfoMsg::clear_has_msg() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void InfoMsg::clear_msg() {
  if (msg_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    msg_->clear();
  }
  clear_has_msg();
}
inline const ::std::string& InfoMsg::msg() const {
  // @@protoc_insertion_point(field_get:rpcboost.test.InfoMsg.msg)
  return *msg_;
}
inline void InfoMsg::set_msg(const ::std::string& value) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    msg_ = new ::std::string;
  }
  msg_->assign(value);
  // @@protoc_insertion_point(field_set:rpcboost.test.InfoMsg.msg)
}
inline void InfoMsg::set_msg(const char* value) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    msg_ = new ::std::string;
  }
  msg_->assign(value);
  // @@protoc_insertion_point(field_set_char:rpcboost.test.InfoMsg.msg)
}
inline void InfoMsg::set_msg(const void* value, size_t size) {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    msg_ = new ::std::string;
  }
  msg_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:rpcboost.test.InfoMsg.msg)
}
inline ::std::string* InfoMsg::mutable_msg() {
  set_has_msg();
  if (msg_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    msg_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:rpcboost.test.InfoMsg.msg)
  return msg_;
}
inline ::std::string* InfoMsg::release_msg() {
  clear_has_msg();
  if (msg_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void InfoMsg::set_allocated_msg(::std::string* msg) {
  if (msg_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete msg_;
  }
  if (msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:rpcboost.test.InfoMsg.msg)
}

// required int32 id = 2;
inline bool InfoMsg::has_id() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void InfoMsg::set_has_id() {
  _has_bits_[0] |= 0x00000002u;
}
inline void InfoMsg::clear_has_id() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void InfoMsg::clear_id() {
  id_ = 0;
  clear_has_id();
}
inline ::google::protobuf::int32 InfoMsg::id() const {
  // @@protoc_insertion_point(field_get:rpcboost.test.InfoMsg.id)
  return id_;
}
inline void InfoMsg::set_id(::google::protobuf::int32 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:rpcboost.test.InfoMsg.id)
}
